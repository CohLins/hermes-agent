...
# Keep the files in the repository for reference, but do not collect tests for
# capabilities intentionally removed from this distribution.
collect_ignore = [
    "e2e",
    "integration/test_voice_channel_flow.py",
]
...
collect_ignore_glob = [
    ...
    "agent/test_video_gen_*.py",
    "hermes_cli/test_video_gen_*.py",
    "plugins/test_discord_runtime_failure.py",
    "plugins/platforms/**/*.py",
    "plugins/video_gen/**/*.py",
    "gateway/test_background_command.py",
    "gateway/test_bluebubbles.py",
    "gateway/test_msgraph_webhook.py",
    "gateway/test_multiplex_http_routing.py",
    "gateway/test_platform_http_client_limits.py",
    "gateway/test_qqbot.py",
    "gateway/test_platform_connected_checkers.py",
    "gateway/test_config_driven_access_policy.py",
    "gateway/test_dingtalk.py",
    "gateway/test_discord_*.py",
    "gateway/test_dm_topics.py",
    "gateway/test_email.py",
    "gateway/test_google_chat.py",
    "gateway/test_homeassistant.py",
    "gateway/test_irc_adapter.py",
    "gateway/test_line_plugin.py",
    "gateway/test_matrix*.py",
    "gateway/test_mattermost.py",
    "gateway/test_media_download_retry.py",
    "gateway/test_ntfy_plugin.py",
    "gateway/test_raft_adapter.py",
    "gateway/test_send_image_file.py",
    "gateway/test_send_multiple_images.py",
    "gateway/test_signal*.py",
    "gateway/test_simplex_plugin.py",
    "gateway/test_teams.py",
    "gateway/test_webhook_*.py",
    "gateway/test_slack*.py",
    "gateway/test_telegram*.py",
    "gateway/test_wecom*.py",
    "gateway/test_weixin*.py",
    "gateway/test_whatsapp*.py",
    "hermes_cli/test_dingtalk_*.py",
    "hermes_cli/test_discord_*.py",
    "hermes_cli/test_video_gen_picker.py",
    "hermes_cli/test_signal_*.py",
    "hermes_cli/test_slack_*.py",
    "hermes_cli/test_telegram_*.py",
    "hermes_cli/test_webhook_*.py",
    "hermes_cli/test_whatsapp_*.py",
    "providers/test_plugin_discovery.py",
    "providers/test_profile_wiring.py",
    "providers/test_provider_profiles.py",
    "test_telegram_*.py",
    "tools/test_discord_*.py",
    "tools/test_homeassistant_tool.py",
    "tools/test_send_message_missing_platforms.py",
    "tools/test_send_message_react.py",
    "tools/test_send_message_telegram_proxy.py",
    "tools/test_send_message_tool.py",
    "tools/test_media_caption_split.py",
    "tools/test_signal_media.py",
    "tools/test_telegram_send_message_caption.py",
