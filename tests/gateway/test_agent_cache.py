...
class TestAgentCacheBoundedGrowth:
    ...
    def test_is_session_finalizable_real_predicate(self, tmp_path):
        ...
        config.reset_by_platform[Platform.FEISHU] = SessionResetPolicy(mode="none")
        ...
        assert store.is_session_finalizable(_entry_for(Platform.FEISHU)) is False
        # default 'both' → finite, will eventually expire.
        assert store.is_session_finalizable(_entry_for(Platform.FEISHU)) is True
