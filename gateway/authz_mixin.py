...
class GatewayAuthorizationMixin:
    ...
    def _is_user_authorized(self, source: SessionSource) -> bool:
        ...
        # Feishu events always traverse the same fail-closed authorization path.
        user_id = source.user_id

        # Bots admitted by FEISHU_ALLOW_BOTS bypass the human allowlist.
        ...
        platform_group_user_env_map: dict[Platform, str] = {}
        platform_group_chat_env_map: dict[Platform, str] = {}
    ...
    def _get_unauthorized_dm_behavior(
        ...
        *,
        ...
        # Adapter-level policies can opt into pairing or silent drops.
        if platform:
        ...
        if platform:
            ...
            platform_group_env_map: dict[Platform, tuple[str, ...]] = {}
